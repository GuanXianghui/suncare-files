...
public class MD5Util
{
    ...
    public static void main(String args[])
    {
        ...
        if(Array.getLength(args) == 0)
        {
            ...
            System.out.println("MD5(\"a\"):" + md5.md5("a"));
            System.out.println("MD5(\"abc\"):" + md5.md5("abc"));
            System.out.println("MD5(\"message digest\"):" + md5.md5("message digest"));
            System.out.println("MD5(\"abcdefghijklmnopqrstuvwxyz\"):" + md5.md5("abcdefghijklmnopqrstuvwxyz"));
            System.out.println("MD5(\"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789\"):" + md5.md5("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"));
        } else
        {
            System.out.println("MD5(" + args[0] + ")=" + md5.md5(args[0]));
        }
    }
}
