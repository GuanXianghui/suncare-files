        ...
        <ul id="main-nav">
            <li><a href="#" class="nav-top-item current"> 用户管理 </a>
                <ul>
                    ...
                    <%if(isSuperMan){%>
                    <li><a href="<%=baseUrl%>createUser.jsp" class="current">新增用户</a></li>
                    <%}%>
        ...
        <fieldset>
            <p>
                ...
                <input class="text-input small-input" type="text" disabled="disabled"
                       value="<%=PropertyUtil.getInstance().getProperty(BaseInterface.DEFAULT_PASSWORD)%>"/>&nbsp;&nbsp;
                <input class="button" type="button" onclick="createUser();" value="新建" />
            </p>
        </fieldset>
        <div class="clear"></div>
    </form>
