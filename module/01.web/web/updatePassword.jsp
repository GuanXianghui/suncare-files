        ...
        <ul id="main-nav">
            <li><a href="#" class="nav-top-item current"> 用户管理 </a>
                <ul>
                    ...
                    <%}%>
                    <li><a href="<%=baseUrl%>updatePassword.jsp" class="current">修改密码</a></li>
                </ul>
            </li>
...
<div class="tab-content default-tab" id="tab1">
    ...
    <form>
        <fieldset>
            <p>
                <span>你的用户名</span>&nbsp;&nbsp;
                <input class="text-input small-input" type="text" value="<%=user.getName()%>" disabled="disabled"/>&nbsp;&nbsp;
                <span>新密码</span>&nbsp;&nbsp;
                <input class="text-input small-input" type="password" id="password" />&nbsp;&nbsp;
