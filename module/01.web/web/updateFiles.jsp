        ...
        <div class="content-box">
            <div class="content-box-header">
                ...
                <ul class="content-box-tabs">
                    ...
                    <li><a href="#tab2">上图</a></li>
                    <li><a href="#tab3">看图</a></li>
                </ul>
                <div class="clear"></div>
            </div>
            <div class="content-box-content">
                ...
                <div class="tab-content" id="tab2">
                    ...
                    <form action="<%=baseUrl%>uploadFilesPhoto.do?token=<%=token%>" name="uploadFilesPhotoFrom"
                          method="post" autocomplete="off" enctype="multipart/form-data">
                        <input type="hidden" name="filesId" value="<%=filesId%>">
                        <fieldset>
                            <p>
                                <span>描述</span>&nbsp;&nbsp;
                                <input class="text-input small-input" name="photoDesc" type="text" value=""/>
                            </p>
                            <div id="photos">
                                <p>
                                    <span>照片</span>&nbsp;&nbsp;
                            ...
                            <p>
                                <input class="button" type="button" onclick="uploadFilesPhoto()" value="上传 "/>
                                <input class="button" type="button" onclick="addFilesPhoto()" value="加图"/>
                            </p>
                        </fieldset>
                        <div class="clear"></div>
                    </form>
                ...
                <div class="tab-content" id="tab3">
                    <div id="message_id3" class="notification information png_bg" style="display: none;">
                        <a href="#" class="close">
                            <img src="images/icons/cross_grey_small.png" title="关闭" alt="关闭"/>
                        </a>

                        <div id="message_id3_content"> 提示信息！</div>
                    </div>
                    <div>
                        <%
                    ...
                    <div id="big_img_div" align="center" style="display: none; overflow: auto;">
                        <div align="left">
                            <form name="updateFilesPhotoForm" action="<%=baseUrl%>updateFilesPhoto.do" method="post">
                                <input class="button" type="button" onclick="moveLeft()" value="左移"/>
                                <input class="button" type="button" onclick="moveRight()" value="右移"/>
                                <input class="button" type="button" onclick="deletePhoto()" value="删除"/>
                                <br>
                                <input type="hidden" name="token" id="filesPhotoToken">
                                <input type="hidden" name="filesPhotoId" id="filesPhotoId">
                                <input type="hidden" name="updateFilesPhotoType" id="updateFilesPhotoType">
                                <fieldset>
                                    <p>
                                        <span>描述</span>&nbsp;&nbsp;
                                        <input class="text-input small-input" name="photoDesc" type="text" id="filesPhotoDesc"/>
                                        <input class="button" type="button" onclick="updatePhoto()" value="修改"/>
                                    </p>
                                </fieldset>
                                <div class="clear"></div>
                            </form>
